...
_TARGET = Path(__file__).resolve().parent / "material_master" / "import_review_catalog_to_postgres.py"

if __name__ == "__main__":
    runpy.run_path(str(_TARGET), run_name="__main__")
else:
    _spec = importlib.util.spec_from_file_location("_nexterp_script_import_review_catalog_to_postgres", _TARGET)
