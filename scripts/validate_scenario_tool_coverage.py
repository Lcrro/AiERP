...
_TARGET = Path(__file__).resolve().parent / "scenarios" / "validate_scenario_tool_coverage.py"

if __name__ == "__main__":
    runpy.run_path(str(_TARGET), run_name="__main__")
else:
    _spec = importlib.util.spec_from_file_location("_nexterp_script_validate_scenario_tool_coverage", _TARGET)
