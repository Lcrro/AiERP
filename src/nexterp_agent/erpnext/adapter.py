...
class ERPNextAdapter(
    ...
    def __init__(self, client: ERPNextClient) -> None:
        ...
        self.handlers: dict[str, Callable[[dict[str, Any]], ToolResult]] = {
            ...
            "erpnext.accounting.create_supplier_payment_from_purchase_invoice_draft": self._accounting_create_supplier_payment_from_purchase_invoice_draft,
            ...
            "erpnext.accounting.cancel_financial_document": self._accounting_cancel_financial_document,
            ...
            "erpnext.stock.get_transfer_context": self._stock_get_transfer_context,
            "erpnext.stock.create_transfer_draft": self._stock_create_transfer_draft,
            "erpnext.stock.verify_transfer_impact": self._stock_verify_transfer_impact,
            ...
            "erpnext.projects.get_project_exceptions": self._projects_get_project_exceptions,
            "erpnext.projects.create_task": self._projects_create_task,
            "erpnext.projects.update_task": self._projects_update_task,
