...
ROLE_CAPABILITY_LINKS: dict[str, tuple[str, ...]] = {
    ...
    "ROLE-MAT-EQP-MGR": (
        "cap.material_lookup", "cap.material_classification", "cap.material_creation", "cap.document_lookup", "cap.material_request",
    ...
    "ROLE-SYSADMIN": ("cap.material_lookup", "cap.material_classification", "cap.material_creation", "cap.document_lookup"),
}
