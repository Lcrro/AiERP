...
DEFAULT_CASES = ROOT / "data" / "evals" / "stock_agent_cases.json"
DEFAULT_REPORT = ROOT / "data" / "runtime" / "stock_agent_eval_report.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run non-writing DeepSeek stock Agent evaluations.")
