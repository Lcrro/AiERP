...
_TARGET = Path(__file__).resolve().parent / "material_master" / "export_material_group_mapping.py"

if __name__ == "__main__":
    runpy.run_path(str(_TARGET), run_name="__main__")
else:
    _spec = importlib.util.spec_from_file_location("_nexterp_script_export_material_group_mapping", _TARGET)
